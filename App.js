...
// TODO:
// - Prayer/reading-specific icons
// - Splash screen image doesn't look right (just add transparent padding to base image (the original, large one))
...
const LeftContent = props => <Avatar.Icon {...props} backgroundColor="#8f6b50" icon={require('./assets/favicon.png')} />
        ...
        <View style={styles.container}>
          ...
          <ScrollView style={styles.scrollView}>
            <View style={styles.scrollViewPadding}>
              <Card>
                <Card.Title title="Opening Prayer" left={LeftContent} />
                <Card.Content>
              ...
              <Card>
                <Card.Title titleNumberOfLines={2} title="Confession of Sin and Prayer for Grace" left={LeftContent} />
                <Card.Content>
              ...
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="Old Testament Reading" subtitle="Proverbs 23" subtitleStyle={styles.subtitleStyle} left={LeftContent} />
              ...
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="The Lord's Prayer" left={LeftContent} />
                <Card.Content>
              ...
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="New Testament Reading" subtitle="Luke 4:21-30" subtitleStyle={styles.subtitleStyle} left={LeftContent} />
                <Card.Actions style={styles.readingActions}>
                  <Button onPress={() => console.log("Open to this passage")} color="#8f6b50">Read</Button>
                </Card.Actions>
              </Card>
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="Prayer of Adoration" left={LeftContent} />
                <Card.Content>
              ...
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="Psalm Reading" subtitle="Psalm 111" subtitleStyle={styles.subtitleStyle} left={LeftContent} />
                <Card.Actions style={styles.readingActions}>
                  <Button onPress={() => console.log("Open to this passage")} color="#8f6b50">Read</Button>
                </Card.Actions>
              </Card>
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="Prayer of Consecration" left={LeftContent} />
                <Card.Content>
              ...
              <View style={styles.verticalSpacer} />
              <Card>
                <Card.Title title="Benediction" left={LeftContent} />
                <Card.Content>
